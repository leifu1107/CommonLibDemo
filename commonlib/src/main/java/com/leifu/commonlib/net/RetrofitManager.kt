...
import com.leifu.commonlib.net.api.ApiService
import com.leifu.commonlib.util.LogUtil
import com.leifu.commonlib.util.NetworkUtil
import com.leifu.commonlib.util.SpUtil
import okhttp3.*
...
object RetrofitManager {
    val apiService: ApiService by lazy {
        LogUtil.e("RetrofitManager apiService")
    ...
    private fun getOkHttpClient(): OkHttpClient {
        ...
        return OkHttpClient.Builder()// todo 引入了动态替换baseurl
...
//                .header("user-holder", SpUtil.getString(Constants.SP_HEAD, ""))
            if (!TextUtils.isEmpty(SpUtil.getString(Constants.SP_TOKEN, ""))) {
                requestBuilder.header(
                    "Authorization",
                    "bearer" + SpUtil.getString(Constants.SP_TOKEN, "")
                )
            }
