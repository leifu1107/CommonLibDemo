...
object SpUtil {
    ...
    val appSp: SharedPreferences
        get() = BaseApplication.context.getSharedPreferences(sp_name, Context.MODE_PRIVATE)
     ...
     */
    fun removeAll() {
        val sp = BaseApplication.context.getSharedPreferences(sp_name, Activity.MODE_PRIVATE)
        sp.edit().clear().apply()
    }
     ...
     */
    fun removeUseData() {
//        remove(Constants.SP_TOKEN)
//        remove(Constants.SP_USER_ID)
//        remove(Constants.SP_USER_NAME)
//        remove(Constants.SP_USER_PHONE)
    }
