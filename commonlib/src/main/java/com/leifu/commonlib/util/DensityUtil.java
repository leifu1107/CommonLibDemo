...
public class DensityUtil {
    ...
    public static int getStatusHeight() {
        ...
        try {
            ...
            statusHeight = BaseApplication.Companion.getContext().getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return statusHeight;
    ...
    public static DisplayMetrics getDisplayMetrics() {
        WindowManager manager = (WindowManager) BaseApplication.Companion.getContext().getSystemService(Context.WINDOW_SERVICE);
